...
- block-entity 特殊 renderer（skull/head、end portal/gateway、spawner 旋转体）：
  chest 全家族
  ...
  分片 renderer）已完成；判据与 defer 边界见账本
  "Terrain Block Presentation Parity" 条目；其余 BE 方块（skull/head、
  end portal/gateway、spawner 旋转体）仍缺，按最小子片继续；随行审计
