...
- block-entity 特殊 renderer（end portal/gateway、spawner 旋转体；player-head
  ...
  animation tick）已完成；判据与 defer 边界见账本
  "Terrain Block Presentation Parity" 条目；其余 BE 方块（end portal/gateway、
  spawner 旋转体）仍缺，按最小子片继续；随行审计
