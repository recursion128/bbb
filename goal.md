...
- 2026-06-28 outline closeout：texture-backed static-atlas
  ...
  outline、以及可见 glowing entity 的完整 final outline presentation，归入
  P0 visual / 后续，不再阻塞狭义 pipeline 表达。
...
- 2026-06-28 stale unsupported ledger audit：`docs/unsupported-features.md` 中
  ...
  force-transparent alpha 已按 vanilla `0x26ffffff` 输出并纳入测试。
