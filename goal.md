...
4. 接下来从未完成优先级里选最靠前、可验证、可合并的小 slice：优先 P1 的
   实体专用 renderer 行为、物品/GUI/Frame/第一人称表现、透明排序/粒子/Level
   Events；P2/P3 只在能形成明确闭环或阻塞更高优先级时提前。
5. 粒子 provider、实体动画、terrain、HUD、first-person、GUI 仍避免“无限补细节”；
   只有当 slice 有明确 vanilla 源码依据、完成标准和测试/ledger 更新时才展开。
