...
- [x] 3. 将主要 residual emit 路径逐步迁入 submission 生成；当前
  textured 主 residual arm 已清空并移除，后续只剩 residual / bespoke layer
  helpers 和 GPU path 的更细粒度状态迁移。
