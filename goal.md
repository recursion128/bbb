...
- [x] colored/textured/`breezeWind` entity shader 已从标量 lightmap shade 改为
  ...
  parabolic mix，sky light 使用默认 white，ambient 默认 black；dynamic
...
- 补齐 vanilla `Lightmap` 的动态环境颜色、darkness / night-vision 曲线，以及
