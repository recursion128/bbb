...
- debug overlay（F3 基础 toggle、左列 version/position/help shell、右列
  ...
  profiling metrics recorder/output、DebugOptionsScreen narration/EditBox full
  widget styling polish、native pause tick-freeze eligibility/full PauseScreen remaining buttons/actions，
  低优先）。
