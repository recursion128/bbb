...
- recipe-book overlay page recipe buttons/ghost recipe/recipe placement/tab notification
  animation（基础 shell 已完成）/ advancement screen（大件；recipe/advancement state 已
