...
- [x] pack/native 已解析 vanilla 26.1 biome JSON 顶层 `attributes` 中的
  ...
  公式提亮。更多 non-SKY modifiers、rain-fog smoothing 与完整 sky / cloud
  renderer mesh 消费这些 visibility ends 仍是
  后续 P0 visual 精度项。
