...
- block-entity 特殊 renderer（spawner 旋转体；player-head
  profile skin 随 P3 动态纹理/profile 管线）：
  chest 全家族
  ...
  专用 15/16-layer shader parity 仍留账本）已完成；判据与 defer 边界见账本
  "Terrain Block Presentation Parity" 条目；其余 BE 方块（spawner 旋转体）
  仍缺，按最小子片继续；随行审计
