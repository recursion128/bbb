...
- debug overlay（F3 基础 toggle、左列 version/position/help shell、右列
  ...
  profiling metrics recorder/output、DebugOptionsScreen narration/exact EditBox
  cursor-selection/full widget styling polish、native pause tick-freeze eligibility/full PauseScreen menu，
  低优先）。
