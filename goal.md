...
- 2026-06-29 pipeline-closeout audit refresh：再次运行 `rg residual` /
  ...
  Light1_Direction, Normal, Color)`，当前 item path 仍把
  `Direction.getShade` 烘进顶点色；该差异归入 P0 visual 的 item/entity
  lighting-context 精度，不阻塞 submission checklist。
