...
| [ ] P2：屏幕、HUD、字体与截图 | [ ] 未完成 | [x] screenshot readback BGRA/RGBA surface conversion 和 unsupported-format gate 已有 deterministic 单测 | vanilla font、HUD、screens、broader screenshot/readback |
...
- [x] screenshot readback 对 renderer 选择的 `Bgra8Unorm` /
  ...
  BGRA/RGBA 转换枚举，并用 deterministic 单测覆盖 row-to-RGBA 转换和
