...
- block-entity 特殊 renderer（conduit/skull…）：chest 全家族
  ...
  `(floorMod(x·7+y·9+z·13+gameTime,100)+partial)/100` 相位；判据与 defer
  边界见账本 "Terrain Block Presentation Parity" 条目）已完成；其余 BE
  方块（conduit/skull/附魔台书/lectern 书/end portal/spawner 旋转体）
