...
| P0：光照、Overlay、Invisible / Outline | 进行中 | 大量实体 base/layer light 与 overlay metadata pinning；spectator-visible invisible living entity 边界；wolf body armor invisible layer exception | 更精确 light/gamma/diffuse、统一 overlay、invisible/glowing/outline 分支 |
