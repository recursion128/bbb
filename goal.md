...
| [ ] P2：屏幕、HUD、字体与截图 | [ ] 未完成 | [x] screenshot surface format chooser、BGRA/RGBA readback conversion 和 unsupported-format gate 已有 deterministic 单测 | vanilla font、HUD、screens、broader screenshot/readback |
