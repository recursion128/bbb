...
4. 如果没有新的 P0 blocker，同一轮自动选择并开启下一条 P1 slice：先从当前
   P1 子队列选首个能用 vanilla 源码旁证、能用 focused test 或 ledger 更新验证
   的小 slice；当前子队列无可执行项时，顺延到下一条 P1 子队列。
