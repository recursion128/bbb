...
| P1：实体专用 renderer 行为 | 进行中 | 多类实体专用模型/layer 已落地；boat/raft 的 paddle rowing、hurt roll、bubble wobble、underwater gate、water mask submission 已完成 | boat/raft lighting；sheep/wolf invisible/outline/overlay；大型模型、humanoid、beam/emissive 细节 |
