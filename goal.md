...
| [ ] P3：资源与动态纹理泛化 | [ ] 进行中 | [x] player skin/cape/elytra profile dynamic textures decode/cache/upload/fallback；[x] `PlayerSkin.Patch` body/cape/elytra resource override ready/failed/no-stale texture coverage | broader dynamic texture loading、resource-pack override、ready/pending/failed 状态 |
