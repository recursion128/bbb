...
| P1：物品、GUI、Frame 与第一人称表现 | [ ] 进行中 | [x] shared item-model primitive；[x] 主要 third-person consumers；[x] profile skin/cape/elytra decode/cache/upload/sampling；[x] glow item-frame border/item lighting | first-person viewmodel、hand-use/arm pose、item lighting、filled-map/invisible item frame、HUD/inventory |
