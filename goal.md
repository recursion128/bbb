...
| --- | --- | --- | --- |
| 原始优先级 1-4 | [x] 已完成 | [x] render type 细分；[x] 显式 `order` / `submit_sequence`；[x] 主要 residual emit 迁入 submission 生成；[x] vanilla 源码旁证测试覆盖 texture/render type/tint/transform/order | 后续差异已拆入 P0/P1/P2/P3 |
