...
- [x] pack/native 已解析 vanilla 26.1 biome JSON 顶层 `attributes` 中的
  ...
  `CLOUD_COLOR` modifiers。完整 clouds target / transparency post-chain 以及
  pack-driven custom EnvironmentAttribute 泛化仍是后续
  P0 visual / P3 资源精度项。
