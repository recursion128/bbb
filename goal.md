...
- 补齐 world/native 到 renderer `LightmapEnvironment` 的剩余 biome/spatial
  ...
  start/end offsets 已覆盖；atmospheric sunrise/sunset clear-color mix 已覆盖。
