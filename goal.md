...
- 补齐 world/native 到 renderer `LightmapEnvironment` 的 timeline/weather/biome/
  spatial camera `EnvironmentAttributes` 动态来源；补齐 conduit power 依赖的
  `LocalPlayer.getWaterVision` 水下 night-vision 路径。
