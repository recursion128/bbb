...
- 补齐 world/native 到 renderer `LightmapEnvironment` 的 timeline/weather/biome/
  spatial camera `EnvironmentAttributes` 动态来源；补齐 darkness /
  night-vision 曲线，以及 brightness 被 darkness modifier 动态扣减的路径。
