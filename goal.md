...
- [x] Simple Spell provider（Infested / RaidOmen / TrialOmen）随机水平初速度、
  age sprite、lifetime、尺寸缩放和物理 metadata；带 option color/power 的
  spell variants 仍在剩余 provider-specific 行为内。
