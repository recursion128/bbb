...
- 最新 audit 计数（2026-07-03 elder-guardian particle slice 后复核）：
...
- 2026-07-03 elder-guardian particle special-group model submit 已按 vanilla
  ...
  `0.42553192` 粒子 scale 与 `2.35` elder baked-layer scale。剩余 special-group
  渲染面是 `ItemPickupParticle` carried entity submit。
