...
- `rg unsupported` + `docs/unsupported-features.md` 对照：仍属 P0 blocker 的是
  vanilla outline target / composite、force-transparent presentation、full render-graph sorting、
...
- 2026-06-28 stale unsupported ledger audit：`docs/unsupported-features.md` 中
  ...
  vanilla outline target / composite、colored force-transparent presentation、
  full render-graph sorting、`LightTexture` / gamma / diffuse 和更细 GPU state
  全部归入 P0 visual 或后续 P1/P2/P3，不再阻塞狭义 pipeline closeout。
