...
- advancement screen tab/tree rendering + tab-click selection pass（本地
  open/close、empty window、footer Done button shell、初始 display-root tab
  选择已完成；`ClientAdvancementsState` ready）。
