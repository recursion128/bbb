...
use bbb_renderer::{
    ...
    HudPlayerHealth, HudSignEditorScreen, HudStatsScreen, HudStyledTextRun, HudTitleText,
...
pub(crate) struct RendererFrame {
    ...
    pub(crate) hud_stats_screen: Option<HudStatsScreen>,
    ...
    pub(crate) current_post_effect_id: Option<String>,
...
pub(crate) fn apply_renderer_frame(renderer: &mut Renderer, frame: RendererFrame) {
    ...
    renderer.set_hud_stats_screen(frame.hud_stats_screen);
    ...
    renderer.set_current_post_effect_id(frame.current_post_effect_id);
