...
use crosshair::{
    ...
    protocol_block_pos_from_world, selection_outline_from_crosshair, CrosshairBlockHit,
};
...
mod tests {
    use super::*;
    use bbb_protocol::packets::{
        AddEntity, BlockHitResult as ProtocolBlockHitResult, BlockPos as ProtocolBlockPos,
        CommonPlayerSpawnInfo, PlayLogin, SetPassengers, PLAYER_RELATIVE_DELTA_X,
