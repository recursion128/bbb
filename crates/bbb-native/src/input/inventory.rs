...
mod tests {
    ...
    use bbb_protocol::packets::{
        ...
        OpenScreen, PlayerAbilities, PlayerExperience, RecipePropertySetSummary, RegistryTags,
        SelectBundleItem, SelectTradeCommand, SetBeacon, SetCursorItem, SetEntityData,
        SetPlayerInventory, SlotDisplaySummary, StonecutterSelectableRecipeSummary,
        TagNetworkPayload, UpdateRecipes, UpdateTags, Vec3d,
    };
    use uuid::Uuid;
