...
use bbb_protocol::{
    ...
    packets::{
        ...
        ChangeDifficulty as ProtocolChangeDifficulty, ChunksBiomes as ProtocolChunksBiomes,
        ...
        SetPlayerInventory as ProtocolSetPlayerInventory, TabList as ProtocolTabList,
