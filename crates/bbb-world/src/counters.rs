...
pub struct WorldCounters {
    ...
    #[serde(default)]
    pub select_known_packs_packets: usize,
    #[serde(default)]
    pub known_packs_offered: usize,
    #[serde(default)]
    pub known_packs_selected: usize,
    #[serde(default)]
    ...
    #[serde(default)]
    pub block_destructions_expired: usize,
    #[serde(default)]
    ...
    #[serde(default)]
    pub resource_pack_response_packets: usize,
    #[serde(default)]
    pub resource_pack_response_updates_applied: usize,
    #[serde(default)]
    pub resource_pack_response_updates_ignored: usize,
    #[serde(default)]
    pub resource_pack_required_declines: usize,
    #[serde(default)]
