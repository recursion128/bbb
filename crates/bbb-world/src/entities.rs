...
use bbb_protocol::packets::{
    ...
    RotateHead as ProtocolRotateHead, SetEntityLink as ProtocolSetEntityLink,
    SetEntityMotion as ProtocolSetEntityMotion, TakeItemEntity as ProtocolTakeItemEntity,
    TeleportEntity as ProtocolTeleportEntity,
};
