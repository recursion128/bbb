...
use bbb_protocol::{
    ...
    packets::{
        ...
        DebugEvent, DebugSample, EntityAnimation, EntityEvent, EntityMove, EntityPositionSync,
        Explosion, ForgetLevelChunk, GameEvent, GameRuleValues, GameTestHighlightPos,
        HurtAnimation, InitializeBorder, InteractionHand, LevelChunkWithLight, LevelEvent,
        LevelParticles, LightUpdate, MountScreenOpen, MoveVehicle, OpenBook, OpenScreen,
        OpenSignEditor, PickItemFromBlock, PlaceGhostRecipe, PlayLogin, PlayTime, PlayerAbilities,
        PlayerAction, PlayerCombatEnd, PlayerCombatKill, PlayerCommand, PlayerExperience,
        PlayerHealth, PlayerInfoRemove, PlayerInfoUpdate, PlayerInput, PlayerLookAt,
        ...
        Transfer, UpdateAttributes, UpdateMobEffect, UseItem, UseItemOn, Vec3d,
    },
};
