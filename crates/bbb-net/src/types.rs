...
use bbb_protocol::{
    ...
    packets::{
        ...
        ContainerSetData, ContainerSetSlot, Cooldown, CustomChatCompletions, CustomReportDetails,
        ...
        InteractionHand, LevelChunkWithLight, LevelEvent, LevelParticles, LightUpdate,
        MountScreenOpen, MoveVehicle, OpenBook, OpenScreen, OpenSignEditor, PickItemFromBlock,
        PlaceGhostRecipe, PlayLogin, PlayTime, PlayerAbilities, PlayerAction, PlayerCommand,
        PlayerExperience, PlayerHealth, PlayerInfoRemove, PlayerInfoUpdate, PlayerInput,
        PlayerPositionState, PlayerPositionUpdate, PlayerRotationUpdate, PongResponse,
        ProjectilePower, RemoveEntities, RemoveMobEffect, ResetScore, ResourcePackPop,
        ResourcePackPush, Respawn, RotateHead, SectionBlocksUpdate, SelectAdvancementsTab,
        ServerData, ServerLinks, SetActionBarText, SetBorderCenter, SetBorderLerpSize,
        ...
        SetSimulationDistance, SetSubtitleText, SetTitleText, SetTitlesAnimation, SoundEntityEvent,
        SoundEvent, StopSound, SystemChat, TabList, TagQuery, TakeItemEntity, TeleportEntity,
        TestInstanceBlockStatus, TickingState, TickingStep, Transfer, UpdateAttributes,
