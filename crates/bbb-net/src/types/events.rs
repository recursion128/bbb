use bbb_protocol::packets::{
    ...
    MoveMinecartAlongTrack, MoveVehicle, OpenBook, OpenScreen, OpenSignEditor, PlaceGhostRecipe,
    PlayLogin, PlayTime, PlayerAbilities, PlayerChat, PlayerCombatEnd, PlayerCombatKill,
    PlayerExperience, PlayerHealth, PlayerInfoRemove, PlayerInfoUpdate, PlayerLookAt,
    ...
    SetBorderLerpSize, SetBorderSize, SetBorderWarningDelay, SetBorderWarningDistance, SetCamera,
    SetChunkCacheCenter, SetChunkCacheRadius, SetCursorItem, SetDefaultSpawnPosition,
    SetDisplayObjective, SetEntityData, SetEntityLink, SetEntityMotion, SetEquipment, SetHeldSlot,
    SetObjective, SetPassengers, SetPlayerInventory, SetPlayerTeam, SetScore,
