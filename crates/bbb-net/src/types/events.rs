use bbb_protocol::packets::{
    ...
    BossEvent, ChangeDifficulty, ChunksBiomes, ClearTitles, CommandSuggestions, ContainerClose,
    ContainerSetContent, ContainerSetData, ContainerSetSlot, Cooldown, CustomChatCompletions,
    CustomPayload, CustomReportDetails, DamageEvent, DebugBlockValue, DebugChunkValue,
    DebugEntityValue, DebugEvent, DebugSample, DeleteChat, DisguisedChat, EntityAnimation,
    EntityEvent, EntityMove, EntityPositionSync, Explosion, ForgetLevelChunk, GameEvent,
    GameRuleValues, GameTestHighlightPos, HurtAnimation, InitializeBorder, LevelChunkWithLight,
    LevelEvent, LevelParticles, LightUpdate, MapItemData, MerchantOffers, MountScreenOpen,
    MoveVehicle, OpenBook, OpenScreen, OpenSignEditor, PlaceGhostRecipe, PlayLogin, PlayTime,
    PlayerAbilities, PlayerChat, PlayerCombatEnd, PlayerCombatKill, PlayerExperience, PlayerHealth,
    PlayerInfoRemove, PlayerInfoUpdate, PlayerLookAt, PlayerPositionUpdate, PlayerRotationUpdate,
    PongResponse, ProjectilePower, RecipeBookAdd, RecipeBookRemove, RecipeBookSettings,
    RemoveEntities, RemoveMobEffect, ResetScore, ResourcePackPop, ResourcePackPush, Respawn,
    RotateHead, SectionBlocksUpdate, SelectAdvancementsTab, ServerData, ServerLinks,
