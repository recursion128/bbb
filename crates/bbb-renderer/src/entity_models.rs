...
pub use model_layers::{
    ...
    boat_entity_texture_refs, camel_entity_texture_refs, chicken_entity_texture_refs,
    cod_entity_texture_refs, cow_entity_texture_refs, creeper_entity_texture_refs,
    drowned_entity_texture_refs, enderman_entity_texture_refs, endermite_entity_texture_refs,
    ...
    illager_entity_texture_refs, llama_entity_texture_refs, minecart_entity_texture_refs,
    ...
    spider_entity_texture_refs, squid_entity_texture_refs, tropical_fish_entity_texture_refs,
