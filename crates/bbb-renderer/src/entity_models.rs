...
pub use model_layers::{
    ...
    illager_entity_texture_refs, minecart_entity_texture_refs, phantom_entity_texture_refs,
...
use textured::{
    ...
    wolf_textured_layer_passes, zombie_textured_layer_passes, EntityModelLayerKind,
