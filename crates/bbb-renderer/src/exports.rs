...
pub use crate::entity_models::{
    ...
    ChickenModelVariant, CowModelVariant, DonkeyModelFamily, EntityArmorMaterial, EntityDyeColor,
    EntityModelBounds, EntityModelInstance, EntityModelKind, EntityModelTextureImage,
    EntityModelTextureRef, EntityRenderState, FoxModelVariant, FrogModelVariant,
...
pub use crate::entity_models::{
    enderman_carried_block_transform, humanoid_hand_attach_transform,
