...
use crate::{
    ...
    hud::{
        create_hud_bind_group_layout, create_hud_pipeline, HudSpriteGpu, HudUvRect,
        HUD_HOTBAR_SLOTS,
    },
...
pub struct Renderer {
    ...
    pub(super) hud_hotbar_item_uvs: [Option<HudUvRect>; HUD_HOTBAR_SLOTS],
...
impl Renderer {
    pub async fn new(window: &Window) -> Result<Self> {
        ...
        Ok(Self {
            ...
            hud_item_atlas: None,
            hud_hotbar_item_uvs: [None; HUD_HOTBAR_SLOTS],
