...
use super::super::model_layers::{
    ...
    CamelWalkLayout, ADULT_CAMEL_PARTS, ADULT_CAMEL_WALK_LAYOUT, ADULT_DONKEY_PARTS,
    ADULT_DONKEY_PARTS_WITH_CHEST, ADULT_HORSE_PARTS, ADULT_LLAMA_PARTS,
    ADULT_LLAMA_PARTS_WITH_CHEST, BABY_CAMEL_PARTS, BABY_CAMEL_WALK_LAYOUT, BABY_DONKEY_PARTS,
