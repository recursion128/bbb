use super::{
    ...
    TexturedModelCubeDesc, TexturedModelPartDesc, MODEL_CUBE_FACES_ALL, MODEL_CUBE_FACE_DOWN,
    MODEL_CUBE_FACE_NORTH, MODEL_CUBE_FACE_UP, PART_POSE_ZERO,
};
...
pub(super) const CONDUIT_CYAN: [f32; 4] = [0.32, 0.78, 0.82, 1.0];
