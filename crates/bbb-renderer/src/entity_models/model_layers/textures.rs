...
// Vanilla baby `DrownedOuterLayer` overlay texture (the white baby outer-layer copy). Master atlas
// only, like the adult outer ref above.
pub(in crate::entity_models) const DROWNED_OUTER_LAYER_BABY_TEXTURE_REF: EntityModelTextureRef =
    EntityModelTextureRef {
        path: "textures/entity/zombie/drowned_outer_layer_baby.png",
        size: [64, 64],
    };
...
pub(in crate::entity_models) const ENTITY_MODEL_TEXTURE_REFS: [EntityModelTextureRef; 690] = [
    PLAYER_SLIM_ALEX_TEXTURE_REF,
    PLAYER_SLIM_ARI_TEXTURE_REF,
    PLAYER_SLIM_EFE_TEXTURE_REF,
    PLAYER_SLIM_KAI_TEXTURE_REF,
    ...
    HORSE_CREAMY_TEXTURE_REF,
    HORSE_CREAMY_BABY_TEXTURE_REF,
    HORSE_CHESTNUT_TEXTURE_REF,
    HORSE_CHESTNUT_BABY_TEXTURE_REF,
    HORSE_BROWN_TEXTURE_REF,
    HORSE_BROWN_BABY_TEXTURE_REF,
    HORSE_BLACK_TEXTURE_REF,
    HORSE_BLACK_BABY_TEXTURE_REF,
    HORSE_GRAY_TEXTURE_REF,
    HORSE_GRAY_BABY_TEXTURE_REF,
    HORSE_DARKBROWN_TEXTURE_REF,
    HORSE_DARKBROWN_BABY_TEXTURE_REF,
    HORSE_MARKINGS_WHITE_TEXTURE_REF,
    HORSE_MARKINGS_WHITE_BABY_TEXTURE_REF,
    HORSE_MARKINGS_WHITEFIELD_TEXTURE_REF,
    HORSE_MARKINGS_WHITEFIELD_BABY_TEXTURE_REF,
    HORSE_MARKINGS_WHITEDOTS_TEXTURE_REF,
    HORSE_MARKINGS_WHITEDOTS_BABY_TEXTURE_REF,
    HORSE_MARKINGS_BLACKDOTS_TEXTURE_REF,
    HORSE_MARKINGS_BLACKDOTS_BABY_TEXTURE_REF,
    ...
    HORSE_BODY_COPPER_TEXTURE_REF,
    HORSE_BODY_IRON_TEXTURE_REF,
    HORSE_BODY_GOLD_TEXTURE_REF,
    HORSE_BODY_DIAMOND_TEXTURE_REF,
...
pub(in crate::entity_models) const HORSE_ENTITY_TEXTURE_REFS: [EntityModelTextureRef; 22] = [
    HORSE_WHITE_TEXTURE_REF,
    HORSE_WHITE_BABY_TEXTURE_REF,
    HORSE_CREAMY_TEXTURE_REF,
    HORSE_CREAMY_BABY_TEXTURE_REF,
...
pub fn horse_entity_texture_refs() -> &'static [EntityModelTextureRef] {
    &HORSE_ENTITY_TEXTURE_REFS
}

pub(in crate::entity_models) const UNDEAD_HORSE_ENTITY_TEXTURE_REFS: [EntityModelTextureRef; 4] = [
    SKELETON_HORSE_TEXTURE_REF,
    SKELETON_HORSE_BABY_TEXTURE_REF,
    ZOMBIE_HORSE_TEXTURE_REF,
    ZOMBIE_HORSE_BABY_TEXTURE_REF,
...
pub(in crate::entity_models) const END_SKY_TEXTURE_REF: EntityModelTextureRef =
    EntityModelTextureRef {
        path: "textures/environment/end_sky.png",
        size: [128, 128],
    };
pub(in crate::entity_models) const END_PORTAL_TEXTURE_REF: EntityModelTextureRef =
    EntityModelTextureRef {
        path: "textures/entity/end_portal/end_portal.png",
        size: [256, 256],
    };
