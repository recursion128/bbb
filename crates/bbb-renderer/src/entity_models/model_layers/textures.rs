...
pub(in crate::entity_models) const ENTITY_MODEL_TEXTURE_REFS: [EntityModelTextureRef; 387] = [
...
pub(in crate::entity_models) const HORSE_ENTITY_TEXTURE_REFS: [EntityModelTextureRef; 14] = [
    HORSE_WHITE_TEXTURE_REF,
    HORSE_WHITE_BABY_TEXTURE_REF,
    HORSE_CREAMY_TEXTURE_REF,
    HORSE_CREAMY_BABY_TEXTURE_REF,
