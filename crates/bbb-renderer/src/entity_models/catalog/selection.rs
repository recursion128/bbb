...
impl EntityModelKind {
    ...
    pub fn vanilla_texture_ref(self) -> Option<EntityModelTextureRef> {
        match self {
            ...
            Self::Sniffer => Some(SNIFFER_TEXTURE_REF),
            Self::Parrot => Some(PARROT_TEXTURE_REF),
            Self::Shulker => Some(SHULKER_TEXTURE_REF),
            Self::EnderDragon => Some(ENDER_DRAGON_TEXTURE_REF),
            Self::Arrow => Some(ARROW_TEXTURE_REF),
            Self::LlamaSpit => Some(LLAMA_SPIT_TEXTURE_REF),
            Self::ShulkerBullet => Some(SHULKER_BULLET_TEXTURE_REF),
            Self::WitherSkull => Some(WITHER_TEXTURE_REF),
            ...
            Self::Frog => Some(FROG_TEXTURE_REF),
            ...
            Self::Fox { baby: false } => Some(FOX_TEXTURE_REF),
            ...
            Self::Strider { baby: true } => Some(STRIDER_BABY_TEXTURE_REF),
            ...
            Self::Bee { baby: false } => Some(BEE_TEXTURE_REF),
            Self::Bee { baby: true } => Some(BEE_BABY_TEXTURE_REF),
