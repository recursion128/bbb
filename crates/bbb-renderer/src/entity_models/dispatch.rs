...
use super::model_layers::{
    ...
    CreeperModel, DolphinModel, DrownedOuterModel, EnderDragonModel, EndermanModel, EndermiteModel,
    EvokerFangsModel, FelineModel, FoxModel, FrogModel, GhastModel, GoatModel, GuardianModel,
    HappyGhastModel, HoglinModel, IllagerModel, IronGolemModel, LeashKnotModel, LlamaModel,
    LlamaSpitModel, MagmaCubeModel, MinecartModel, NautilusModel, PandaModel, ParrotModel,
    PhantomModel, PigModel, PiglinModel, PlayerModel, PolarBearModel, PufferfishModel, RabbitModel,
    RavagerModel, SalmonModel, SheepFurModel, SheepModel, ShulkerBulletModel, ShulkerModel,
...
use super::textured::{
    ...
    shulker_textured_layer_passes, sign_textured_layer_passes, silverfish_textured_layer_passes,
