...
use super::model_layers::{
    ...
    PolarBearModel, PufferfishModel, RabbitModel, RavagerModel, SalmonModel, ShulkerModel,
    ...
    WitchModel, WitherModel, WolfModel, ZombieModel, ALLAY_TEXTURE_REF, ARMOR_STAND_TEXTURE_REF,
    ARROW_PARTS, BAT_TEXTURE_REF, BEE_BABY_TEXTURE_REF, BEE_TEXTURE_REF, BREEZE_TEXTURE_REF,
    COD_TEXTURE_REF, DOLPHIN_BABY_TEXTURE_REF, DOLPHIN_TEXTURE_REF, ENDER_DRAGON_PARTS,
    EVOKER_FANGS_PARTS, FELINE_CAT_SCALE, GUARDIAN_ELDER_SCALE, LLAMA_SPIT_PARTS,
...
use super::textured::{
    ...
    silverfish_textured_layer_passes, snow_golem_textured_layer_passes,
...
pub(in crate::entity_models) fn dispatch_uniform_entity_model<S: EntityModelSink>(
    ...
    match instance.kind {
        ...
        EntityModelKind::EvokerFangs => sink.model(
            StaticModel::new(&EVOKER_FANGS_PARTS),
