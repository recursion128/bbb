...
use super::model_layers::{
    ...
    DolphinModel, EndermanModel, EndermiteModel, EvokerFangsModel, FelineModel, FoxModel,
    FrogModel, GhastModel, GoatModel, GuardianModel, HappyGhastModel, IllagerModel, IronGolemModel,
    LeashKnotModel, MagmaCubeModel, MinecartModel, NautilusModel, PandaModel, ParrotModel,
    ...
    DOLPHIN_BABY_TEXTURE_REF, DOLPHIN_TEXTURE_REF, ENDER_DRAGON_PARTS, FELINE_CAT_SCALE,
    GUARDIAN_ELDER_SCALE, LLAMA_SPIT_PARTS, PUFFERFISH_TEXTURE_REF, SHULKER_BULLET_PARTS,
    STRIDER_BABY_TEXTURE_REF, STRIDER_TEXTURE_REF, TURTLE_BABY_TEXTURE_REF,
    TURTLE_EGG_ROOT_DROP_POSE, TURTLE_TEXTURE_REF, VEX_TEXTURE_REF, WITHER_SKULL_PARTS,
};
use super::textured::{
...
pub(in crate::entity_models) fn dispatch_uniform_entity_model<S: EntityModelSink>(
    ...
    match instance.kind {
        ...
        EntityModelKind::EnderDragon => sink.model(
            StaticModel::new(&ENDER_DRAGON_PARTS),
