...
use super::model_layers::{
    ...
    DolphinModel, EnderDragonModel, EndermanModel, EndermiteModel, EvokerFangsModel, FelineModel,
    FoxModel, FrogModel, GhastModel, GoatModel, GuardianModel, HappyGhastModel, IllagerModel,
    IronGolemModel, LeashKnotModel, MagmaCubeModel, MinecartModel, NautilusModel, PandaModel,
    ParrotModel, PhantomModel, PigModel, PolarBearModel, PufferfishModel, RabbitModel,
    RavagerModel, SalmonModel, ShulkerModel, SilverfishModel, SnifferModel, SnowGolemModel,
    SpiderModel, StriderModel, TadpoleModel, TridentModel, TurtleModel, VexModel, VillagerModel,
    WanderingTraderModel, WardenModel, WindChargeModel, WitchModel, WitherModel, WolfModel,
    ZombieModel, ALLAY_TEXTURE_REF, ARMOR_STAND_TEXTURE_REF, ARROW_PARTS, BAT_TEXTURE_REF,
    BEE_BABY_TEXTURE_REF, BEE_TEXTURE_REF, BREEZE_TEXTURE_REF, COD_TEXTURE_REF,
    DOLPHIN_BABY_TEXTURE_REF, DOLPHIN_TEXTURE_REF, FELINE_CAT_SCALE, GUARDIAN_ELDER_SCALE,
    LLAMA_SPIT_PARTS, PUFFERFISH_TEXTURE_REF, SHULKER_BULLET_PARTS, STRIDER_BABY_TEXTURE_REF,
    STRIDER_TEXTURE_REF, TURTLE_BABY_TEXTURE_REF, TURTLE_EGG_ROOT_DROP_POSE, TURTLE_TEXTURE_REF,
...
use super::textured::{
    ...
    minecart_textured_layer_passes, parrot_textured_layer_passes, phantom_textured_layer_passes,
    pig_textured_layer_passes, polar_bear_textured_layer_passes, ravager_textured_layer_passes,
...
pub(in crate::entity_models) fn dispatch_uniform_entity_model<S: EntityModelSink>(
    ...
    match instance.kind {
        ...
        EntityModelKind::Rabbit { baby } => sink.model(
