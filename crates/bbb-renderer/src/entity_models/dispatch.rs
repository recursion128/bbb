...
use super::colored::{
    ...
    boat_model_root_transform, camel_model_color, cave_spider_model_root_transform,
    chest_model_root_transform, cod_model_root_transform, creeper_model_root_transform,
    decorated_pot_model_root_transform, emit_donkey_model, emit_horse_model,
    emit_undead_horse_model, end_crystal_model_root_transform, ender_dragon_model_root_transform,
...
use super::model_layers::{
    ...
    AxolotlModel, BatModel, BedModel, BeeModel, BellModel, BlazeModel, BoatModel, BreezeModel,
    CamelModel, ChestModel, ChickenModel, CodModel, CopperGolemModel, CowModel, CreakingModel,
    CreeperModel, DecoratedPotModel, DolphinModel, DrownedOuterModel, EnderDragonModel,
    EndermanModel, EndermiteModel, EvokerFangsModel, FelineModel, FoxModel, FrogModel, GhastModel,
    GoatModel, GuardianModel, HappyGhastModel, HoglinModel, IllagerModel, IronGolemModel,
    LeashKnotModel, LlamaModel, LlamaSpitModel, MagmaCubeModel, MinecartModel, NautilusModel,
    PandaModel, ParrotModel, PhantomModel, PigModel, PiglinModel, PlayerModel, PolarBearModel,
    PufferfishModel, RabbitModel, RavagerModel, SalmonModel, SheepFurModel, SheepModel,
    ShulkerBoxModel, ShulkerBulletModel, ShulkerModel, SignModel, SilverfishModel, SkeletonModel,
    ...
    TurtleModel, VexModel, VillagerModel, WanderingTraderModel, WardenModel, WindChargeModel,
    WitchModel, WitherModel, WitherSkullModel, WolfModel, ZombieModel, ZombieVariantModel,
    ALLAY_TEXTURE_REF, ARMOR_STAND_TEXTURE_REF, BAT_TEXTURE_REF, COD_TEXTURE_REF,
    DOLPHIN_BABY_TEXTURE_REF, DOLPHIN_TEXTURE_REF, END_CRYSTAL_PARTS, FELINE_CAT_SCALE,
...
use super::textured::{
    ...
    bed_textured_layer_passes, bell_textured_layer_passes, blaze_textured_layer_passes,
    boat_textured_layer_passes, breeze_textured_layer_passes, camel_textured_layer_passes,
    chest_textured_layer_passes, chicken_textured_layer_passes, copper_golem_textured_layer_passes,
