...
use super::colored::{
    ...
    conduit_model_root_transform, creeper_model_root_transform, decorated_pot_model_root_transform,
...
use super::model_layers::{
    ...
    BookModel, BreezeModel, CamelModel, ChestModel, ChickenModel, CodModel, ConduitModel,
    CopperGolemModel, CowModel, CreakingModel, CreeperModel, DecoratedPotModel, DolphinModel,
    ...
    SalmonModel, SheepFurModel, SheepModel, ShulkerBoxModel, ShulkerBulletModel, ShulkerModel,
    SignModel, SilverfishModel, SkeletonModel, SlimeModel, SlimeOuterModel, SnifferModel,
...
use super::textured::{
    ...
    chicken_textured_layer_passes, conduit_textured_layer_passes,
    copper_golem_textured_layer_passes, cow_textured_layer_passes, creaking_textured_layer_passes,
    creeper_textured_layer_passes, decorated_pot_textured_layer_passes,
...
pub(in crate::entity_models) fn dispatch_uniform_entity_model<S: EntityModelSink>(
    ...
    match instance.kind {
        ...
        EntityModelKind::Conduit { part } => sink.model(
            ConduitModel::new(part),
            conduit_model_root_transform(*instance, part),
            instance,
