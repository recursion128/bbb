...
use super::colored::{
    ...
    bell_model_root_transform, boat_model_root_transform, camel_model_color,
    cave_spider_model_root_transform, chest_model_root_transform, cod_model_root_transform,
    creeper_model_root_transform, decorated_pot_model_root_transform, emit_donkey_model,
    emit_horse_model, emit_undead_horse_model, enchanting_table_book_model_root_transform,
    ...
    hoglin_model_color, illusioner_model_root_transform, iron_golem_model_root_transform,
    leash_knot_model_root_transform, lectern_book_model_root_transform, llama_model_color,
...
use super::model_layers::{
    ...
    AxolotlModel, BannerModel, BatModel, BedModel, BeeModel, BellModel, BlazeModel, BoatModel,
    BookModel, BreezeModel, CamelModel, ChestModel, ChickenModel, CodModel, CopperGolemModel,
    CowModel, CreakingModel, CreeperModel, DecoratedPotModel, DolphinModel, DrownedOuterModel,
    ...
    NautilusModel, PandaModel, ParrotModel, PhantomModel, PigModel, PiglinModel, PlayerModel,
    PolarBearModel, PufferfishModel, RabbitModel, RavagerModel, SalmonModel, SheepFurModel,
    SheepModel, ShulkerBoxModel, ShulkerBulletModel, ShulkerModel, SignModel, SilverfishModel,
...
use super::textured::{
    ...
    banner_textured_layer_passes, bed_textured_layer_passes, bell_textured_layer_passes,
    blaze_textured_layer_passes, boat_textured_layer_passes, book_textured_layer_passes,
    breeze_textured_layer_passes, camel_textured_layer_passes, chest_textured_layer_passes,
    ...
    decorated_pot_textured_layer_passes, drowned_textured_layer_passes,
    ...
    sign_textured_layer_passes, silverfish_textured_layer_passes, skeleton_textured_layer_passes,
    slime_textured_layer_passes, sniffer_textured_layer_passes, snow_golem_textured_layer_passes,
    spider_textured_layer_passes, squid_textured_layer_passes, tadpole_textured_layer_passes,
...
pub(in crate::entity_models) fn dispatch_uniform_entity_model<S: EntityModelSink>(
    ...
    match instance.kind {
        ...
        EntityModelKind::Chest { texture, half } => sink.model(
            ...
            instance,
            &chest_textured_layer_passes(texture, half),
        ),
        EntityModelKind::Sign { wood, attachment } => sink.model(
            SignModel::new(attachment),
            sign_model_root_transform(*instance, attachment),
            instance,
            &sign_textured_layer_passes(wood, attachment),
        ),
        EntityModelKind::Bed { color, part } => sink.model(
            BedModel::new(part),
            bed_model_root_transform(*instance),
            instance,
            &bed_textured_layer_passes(color, part),
        ),
        EntityModelKind::Bell => sink.model(
            BellModel::new(),
            bell_model_root_transform(*instance),
            instance,
            &bell_textured_layer_passes(),
        ),
        EntityModelKind::ShulkerBox { color, facing } => sink.model(
            ShulkerBoxModel::new(),
            shulker_box_model_root_transform(*instance, facing),
            instance,
            &shulker_box_textured_layer_passes(color),
        ),
        EntityModelKind::DecoratedPot {
            ...
            DecoratedPotModel::new(),
            decorated_pot_model_root_transform(*instance),
            instance,
            &decorated_pot_textured_layer_passes(back, left, right, front),
        ),
        EntityModelKind::Banner {
            ...
            BannerModel::new(wall),
            banner_model_root_transform(*instance),
            instance,
            &banner_textured_layer_passes(wall, base_color, &layers),
        ),
        EntityModelKind::EnchantingBook => sink.model(
            BookModel::new(),
            enchanting_table_book_model_root_transform(*instance),
            instance,
            &book_textured_layer_passes(),
        ),
        EntityModelKind::LecternBook => sink.model(
            BookModel::new(),
            lectern_book_model_root_transform(*instance),
            instance,
            &book_textured_layer_passes(),
        ),
