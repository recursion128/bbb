...
- Evidence / boundary:
  - Current runtime:
    ...
    - Records vanilla particle render-plan metadata for covered single-quad
      ...
      static families, utility/mechanical static families, plus ore/deepslate/nether,
      ...
      static families, non-tinted foliage static families,
      utility/mechanical static families, and
  ...
  - `bbb-audio` has:
    ...
    - native dispatcher playback for randomized vanilla `LevelEventHandler`
      ...
      - particle descriptors map `FallingDustParticle.Provider` for
        ...
        foliage static families, utility/mechanical static families,
