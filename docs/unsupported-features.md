...
- Evidence / boundary:
  - Current runtime:
    ...
    - Records vanilla particle render-plan metadata for covered single-quad
      ...
      families, water plant/egg static families, produce/fungus static
      ...
      water plant/egg static families, and ore/deepslate/nether plus
  ...
  - `bbb-audio` has:
    ...
    - native dispatcher playback for randomized vanilla `LevelEventHandler`
      ...
      - particle descriptors map `FallingDustParticle.Provider` for
        ...
        water plant/egg static families, ore/deepslate/nether colors, and
        mineral/natural static block families.
