...
- Next action (2026-07-05 entry audit; consume in this order):
  - Continue the debug overlay after the F3 toggle, left-column
    ...
    remaining F3+I full local entity saveWithoutId parity beyond local creeper/creaking/shulker/slime-family/snow-golem/bat/blaze/breeze/spider-family/silverfish/bogged/end-crystal/endermite/ghast/interaction/iron-golem/phantom/ravager/wither/zoglin save fields,
...
- Evidence / boundary:
  ...
  - Boundary: recipe-book overlay polish is live, including narrow-screen
    ...
    rows, remaining F3+I full local entity saveWithoutId parity beyond local creeper/creaking/shulker/slime-family/snow-golem/bat/blaze/breeze/spider-family/silverfish/bogged/end-crystal/endermite/ghast/interaction/iron-golem/phantom/ravager/wither/zoglin save fields,
    full vanilla profiler section coverage,
    profiling metrics recorder/output,
