...
- Evidence / boundary:
  - Renderer draws:
    ...
    - textured entity model submits now carry vanilla-shaped submission
      ...
      profile cape plus player WINGS/elytra submissions, axolotl color/age
      base submits, pufferfish puff-state base submits, and the Guardian beam /
      End Crystal body+beam paths are covered by source-verified
