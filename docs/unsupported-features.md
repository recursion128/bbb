...
- Next action:
  ...
  - P0 pipeline closeout also treats the remaining GPU-path fine-grained state as
    ...
    attack animation, BLOCK/shield use pose, and patch-carried consumable
    EAT/DRINK `applyEatTransform`; default/prototype consumables plus remaining
    non-EAT/DRINK use and special consumers remain item presentation follow-ups. Standalone
...
- Evidence / boundary:
  ...
  - Renderer draws:
    ...
    - 3D Block-Model / Item-Model Rendering (main consumers wired): a
      ...
      consumables, and draws in a depth-cleared pass after world transparency is
      composited and before HUD overlays. Remaining refinements are default
      consumable prototype coverage, first-person non-EAT/DRINK use/special
      paths, combat arm poses, and custom ground transforms. Done:
      ...
      - remaining slices: held-item refinements (first-person default consumable,
        non-EAT/DRINK use, and special viewmodel paths;
