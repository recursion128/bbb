...
- Evidence / boundary:
  - Renderer draws:
    ...
    - textured entity model submits now carry vanilla-shaped submission
      ...
      panda gene/age base submits, pufferfish puff-state base submits, rabbit
      color/age/Toast base submits, and the Guardian beam / End Crystal
      body+beam paths are covered by source-verified
